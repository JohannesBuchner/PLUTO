...
int main (int argc, char** argv)
{
  ...
  {
    const char* in_file = "helicoil.inputs";
                     ...
                     Real&     a_dx)
{
  ...
  Real helixR;
  pp.get("helix_radius",helixR);

  Real helixPitch;
  pp.get("helix_pitch",helixPitch);

  Real circleR;
  pp.get("circle_radius",circleR);
  ...
  HelicoilIF implicit(helixR,helixPitch,circleR,insideRegular);
