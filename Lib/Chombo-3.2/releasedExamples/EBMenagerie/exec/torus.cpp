...
int main (int argc, char** argv)
{
  ...
  {
    const char* in_file = "torus.inputs";
                     ...
                     Real&     a_dx)
{
 ...
 CH_assert(n_cell.size() == SpaceDim);
  ...
  pp.get("majorRadius",majorRadius);
  pp.get("minorRadius",minorRadius);
  ...
  TorusIF implicit(majorRadius,minorRadius,center,insideRegular);
