...
#################################################
###  This is the AutoDecl processer.
### Interface is
### sub AutoDeclProc::procAutoDeclMacros(inputfile, outputfile,
###                                SpaceDim, debug)
###
###  reads in input file 
#################################################

package AutoDeclProc;
use vars qw(@ISA @EXPORT @EXPORT_OK %EXPORT_TAGS $VERSION);
use Exporter;
$VERSION = 1.23;
@ISA = qw(Exporter);
@EXPORT = qw(&procAutoDeclMacros);
@EXPORT_OK = qw(&procAutoDeclMacros);
@EXPORT_TAGS= ();

sub AutoDeclProc::procAutoDeclMacros
{
